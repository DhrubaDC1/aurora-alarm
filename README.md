...
```bash
tar -xzf aurora-alarm-0.1.0-linux-x86_64.tar.gz
cd aurora-alarm-0.1.0-linux-x86_64
...
```bash
chmod +x AuroraAlarm-0.1.0-x86_64.AppImage
./AuroraAlarm-0.1.0-x86_64.AppImage
```

#### Flatpak bundle

```bash
flatpak install --user AuroraAlarm-0.1.0-x86_64.flatpak
